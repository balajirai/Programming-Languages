; Find the number of 1’s in the binary form of a given number.
...
; Store the result/count at 2001H
    ...
    MVI B, 00H       ; CURRENT COUNT OF 1'S
    MVI C, 08H       ; BITS/DIGITS IN A BINARY (FOR USING LOOP)
			
BACK: RRC            ; RIGHT ROTATE (IT WILL BRING CARRY = LSB)
    JNC SKIP         ; JUMP IF NO CARRY (JUMP WHEN CY = 0)
    INR B            ; INCREMENT THE COUNT OF 1'S
SKIP: DCR C
    JNZ BACK
